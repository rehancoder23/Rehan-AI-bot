...
@app.get("/")
def home():
    return {"status": "WhatsApp AI Bot is Live on Vercel!"}
...
# Webhook Listener (POST Request for Incoming Messages)
@app.post("/webhook")
...
def send_whatsapp_message(to_number, text):
    ...
    if not token or not phone_id:
        print("Error: WHATSAPP_TOKEN ya PHONE_NUMBER_ID missing hai.")
        return
